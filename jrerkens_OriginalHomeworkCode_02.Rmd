...
```{r}
ppois(q = 7, lambda = 15, lower.tail = F) # NOTE lower.tail = F does not include 8, so we must start at 7
...
1. I struggled with my `YAML` because I forgot to put "output:" in my header. I ended up copying and pasting a header I made at an earlier date, and realized my mistake.\
\
2. I was struggling with adding the `cayman` theme to my document. I knit my document a few times and was failing to compile. I eventually pulled up an old stat homework and found the `prettydoc::pretty_html:` syntax.\
\
